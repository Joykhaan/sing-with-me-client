...
const Review = ({ revie }) => {
    ...
    return (
        <div className='bg-blue-100  mx-8 md:w-1/3 md:mx-auto p-8 mb-8 mt-16'>

            <div className='md:flex justify-center mb-8'>
                <img className='w-20 rounded-full' src={userImg} alt="" />
                <h2 className='text-xl md:text-4xl text-primay mt-6 ml-4 font-bold text-center'> {userName}</h2>
            </div>
